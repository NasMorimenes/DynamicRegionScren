; Função para retornar a descrição da tecla a partir do valor fornecido
GetKeyDescription(VKCode) {
    static KeyDescriptions := 
        Map(
    ...
    return KeyDescriptions[VKCode] ? KeyDescriptions[VKCode] : "Unknown key"
}

; Exemplo de uso da função
VKCode := 0x41  ; Código da tecla 'A'
MsgBox( GetKeyDescription(VKCode) )
